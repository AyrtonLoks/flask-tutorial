...
# which is useful since you won’t necessarily know where that location is when deploying 
...
def init_app(app):
    ...
    # app.teardown_appcontext() tells Flask to call that function (close_db) when 
